...
const { costFactors } = rehabilitationData;

const RehabilitationCostFactors = () => (
  <section className="bg-gray-50">
    <div className="max-w-5xl mx-auto px-6 py-16 lg:py-20">
      ...
      {costFactors.closing && (
        <p className="mx-auto text-center text-gray-600 mt-10 max-w-2xl leading-relaxed">{costFactors.closing}</p>
      )}
    </div>
  </section>
);

export default RehabilitationCostFactors;