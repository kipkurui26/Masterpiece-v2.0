...
const { costFactors } = equippingData;

const EquippingCostFactors = () => (
  <section className="bg-white">
    <div className="max-w-5xl mx-auto px-6 py-16 lg:py-20">
      ...
      {costFactors.closing && (
        <p className="text-gray-600 mt-10 mx-auto max-w-2xl leading-relaxed text-center">{costFactors.closing}</p>
      )}
    </div>
  </section>
);

export default EquippingCostFactors;
